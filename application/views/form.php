     ...
     <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
      ...
      <hr class="sidebar-divider">
       ...
       <li class="nav-item active">
        <a class="nav-link"href="<?php echo base_url()."pir/dashboarduser"?>">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link"  href="<?php echo base_url()."pir/tanggapanuser"?>">
          <i class="fas fa-fw fa-chart-area"></i>
...
<div class="container">
    <h5 style="text-align:center">Silahkan isi aduan anda </h5>
    <br>

    <form action="<?php echo site_url('pir/simpan_aduan')?>" method ='POST' enctype="multipart/form-data">
            <div class="form-grup">
                ...
                <input type="text" class='form-control' name='aduan' >
