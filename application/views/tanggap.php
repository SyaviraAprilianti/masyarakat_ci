...
<li class="nav-item">
 ...
 <!-- logout -->
    ...
    <div class="container">
    <a href="<?= site_url('pir/cetakadu')?>">
        <button type="button" class="btn btn-warning">
        <i class="fa fa-file" aria-hidden="true"> PDF</i>
        </a></button>

    <a href="<?= site_url('pir/cetak_exce')?>">
        ...
        ?>  
                    <tr>
                        ...
                        <td>
                        <div class="col-12">
                        <?php echo anchor('pir/reply/'.$datas['id_pengaduan'],'<button type="button" class="btn btn-success" style="width:89%;">Reply</button>'); ?>
                        </div>
                        <div class="col-12">
                        <?php echo anchor('pir/hapus_adu/'.$datas['id_pengaduan'],'<button type="button" class="btn btn-danger" style="width:89%;">Delete</button>'); ?>
                        </div>
